...
from .nsa_compression import parallel_nsa_compression
...
def parallel_nsa(
    ...
    # TODO assert q.shape[2] % (k.shape[2] * 16) == 0, "Group size must be a multiple of 16 in NSA"
    assert q.shape[2] % k.shape[2] == 0, "Group size must be integer multiple"
